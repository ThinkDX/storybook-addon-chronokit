...
describe('CountdownSimple', () => {
  ...
  it('renders countdown with seconds only when less than a minute', () => {
    ...
    render(<CountdownSimple datetime={target} />)
  ...
  it('updates countdown every second', () => {
    ...
    expect(screen.getByTestId('countdown')).toHaveTextContent('4s')

    act(() => {
      vi.advanceTimersByTime(2000)
    })

    expect(screen.getByTestId('countdown')).toHaveTextContent('2s')
  })
  ...
  it('applies size prop correctly', () => {
    ...
    render(<CountdownSimple datetime={target} size="xl" />)
  ...
  it('applies color prop correctly', () => {
    ...
    render(<CountdownSimple datetime={target} color="red" />)
  ...
  it('applies className prop correctly', () => {
    ...
    render(<CountdownSimple datetime={target} className="custom-class" />)
